---
title: "Phenome-wide Multi-Institutional Multimorbidity Explorer"
author: Siwei Zhang
date: "`r Sys.Date()`"
output:
  rmdformats::downcute:
...
Scientific question is in need: Identifying disease multimorbidity is important in both of preventing multimorbid conditions and providing precision treatment to patients. By unraveling the complex interactions between diseases, researchers could develop more effective treatment strategies that address multiple disease concurrently. Furthermore, 
it may reveal shared molecular mechanisms among various diseases, understanding these molecular connections offers opportunities for innovative targeted intervention and pave the way for drug repurposing, where a single drug can effectively treat multiple conditions simultaneously.

- Reproducibility among different institutions

Electronic Health Records (EHRs) present valuable opportunities to explore robust multimorbidity and complex patterns. However, EHR-based observational studies are often limited to a single institution, where diverse populations and healthcare settings may exist. Moreover, within each institution, biases may arise due to variations in physician experience or systematic errors in diagnosis recording, potentially resulting in disparate disease multimorbidity patterns and limiting result generalizability. Additionally, conducting large-scale studies to identify and replicate disease multimorbidity across different institutions poses significant challenges.

- Efficient and dynamic analysis on disease clusters

Currently, there is no widely adopted visualization tool for conducting statistical analysis and interpreting the latent structures of disease multimorbidity clustering and causation. An effective tool that leverages a large-scale database would offer a comprehensive and valuable resource for both validating known phenome-based multimorbidity patterns and identifying previously unknown ones, while also enhancing statistical power. We provide a detailed demonstration of the overall discovery process, including three case studies that showcase PheMIME (@zhang2023phemime) 's capabilities in identifying phenome-wide disease clusters through association subgraphs (@strayer2023interactive), exploring phenome-wide causal associations, and uncovering novel genetic causes.
